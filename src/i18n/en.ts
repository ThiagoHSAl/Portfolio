    ...
    focus: [
      {
        ...
        text: 'Computer vision on hardware that does not forgive: detectors for the aerial viewpoint, sliced high-resolution inference, and the integration of everything that flies — autopilot, companion computer, camera and radio. It is the track of my undergraduate research at VerLab, measured in the field and not only on a test set.',
      ...
      },
      {
        ...
        text: 'The delivery end: purpose-built APIs, data modeling, standardized metadata and visualization that makes a number comparable. From the FastAPI benchmarks backend to the Datapólis choropleth map — and to this portfolio.',
  ...
  about: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'I train **competitive programming in C++** with the ICPC in mind — my exercise in algorithms and data structures under time pressure, and a healthy counterweight to the pace of research.',
